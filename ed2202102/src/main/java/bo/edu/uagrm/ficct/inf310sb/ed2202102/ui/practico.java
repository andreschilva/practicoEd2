...
public class practico  {
    ...
    public static void resultados() throws ExeceptionOrdenNoValido {
        IArbolBusqueda<Integer,String>  arbolBinario1 = new ArbolBinarioBusqueda<>();
        IArbolBusqueda<Integer,String>  arbolBinario2 ;
        IArbolBusqueda<Integer,String>  arbolBinario3;
        ...
        System.out.println("para las pruebas se inserto las siguientes claves para \n"
                + "arbol1 60,40,100,20,50,45,22,21,23,140,120,125 "
                + " y  arbol2 80,60,45,65,63,49,47,51,95,120,110,115 ");
        ...
        System.out.println("Ejercicio 7.- Cantidad de nodos con ambos Hijos no vacios: " + ((ArbolBinarioBusqueda)arbolBinario1).cantidadNodosConDosHijosNoVacios());   
        System.out.println("Ejercicio 8.- Cantidad de nodos con un Hijo no vacio:       " + ((ArbolBinarioBusqueda)arbolBinario1).cantidadNodosConUnHijo());
        System.out.println("Ejercicio 9.- Cantidad de nodos vacios del Arbol:          " + ((ArbolBinarioBusqueda)arbolBinario1).cantidadNodosVaciosDelArbol() );
        ...
        arbolBinario2 = new ArbolBinarioBusqueda<>(listaClaveInOrden,listaValoresInOrden,listaClavePreOrden, listaValoresPreOrden,true);
        ...
        arbolBinario3 = new ArbolBinarioBusqueda<>(listaClaveInOrden,listaValoresInOrden,listaClavesPostOrden, listaValoresPostOrden,false);
        System.out.println("Ejercicio 10 Reconstruccion Con postOrden" );
        ((ArbolBinarioBusqueda)arbolBinario3).mostrarArbol();
        
        System.out.println("Ejercicio 12 ¿hay Nodos Completos en el Nivel N?");

        if (((ArbolMViasBusqueda)arbolMvias1).hayNodosCompletosNivelN(1)) {
            System.out.println("Hay Nodos Completos en el nivel " + 1);
        }else {
            System.out.println("No hay Nodos Completos en el nivel " + 1);
        }
        
        System.out.println("Ejercicio 14 ¿Son Arboles Similares? con Arboles Mvias");
    ...
    public static void menuArbolBin() throws ExcepcionClaveNoexiste {
        ...
        while (!salir) {            
            ...
            System.out.println("4 insertar automatico Arbol Binario");
            ...
            System.out.println("12 Ejercicio 10 Reconstruccion InOrden, postOrden");
    ...
    public static void menuArbolAvl() throws ExcepcionClaveNoexiste {
        ...
        while (!salir) {            
            ...
            System.out.println("4 Insertar automatico Arbol AVL");
            System.out.println("5 Recorrido porNiveles");
            System.out.println("6 Recorrido preOrden");
            System.out.println("7 Recorrido inOrden");
            System.out.println("8 Recorrido postOrden");
    ...
    public static void subMenuArbol2(IArbolBusqueda<Integer,String> arbolBinario2) throws ExcepcionClaveNoexiste {
        ...
        while (!salir2) {      
            ...
            System.out.println("4. salir y motrar los resultados");
            try {
                System.out.println("Elija una opcion: ");
                opcion2 = in.nextInt();
                ...
                switch(opcion2) {
                    case 1: 
                            ...
                            arbolBinario2.insertar(clave1, valor1);                                            
                            break;     
                    case 2: 
                            arbolBinario2.insertar(80, "andres silva");
                            arbolBinario2.insertar(60, "Pepe serrate");
                            arbolBinario2.insertar(45, "Juan Morales");
                            arbolBinario2.insertar(65, "Juana flores");
                            arbolBinario2.insertar(63, "Armando Paredes");
                            arbolBinario2.insertar(49, "Joaquin Chumacero");
                            arbolBinario2.insertar(47, "Roberto ");
                            arbolBinario2.insertar(51, "juan ");
                            arbolBinario2.insertar(95, "Ana ");
                            arbolBinario2.insertar(120, "Marcos ");
                            arbolBinario2.insertar(110, "Leoncio ");
                            arbolBinario2.insertar(115, "Lucas ");
                            break; 
                    case 3:
                            System.out.println("claveAEliminar");
                            Integer claveAEliminar1 = in.nextInt();
                            System.out.println("valor Eliminado: " + arbolBinario2.eliminar(claveAEliminar1));
                            break;   
                    case 4: 
                            salir2 = true;
                            break;      
    ...
    public static void menuArbolMvias() throws ExcepcionClaveNoexiste, ExeceptionOrdenNoValido {
        ...
        while (!salir) {            
            ...
            System.out.println("4 Insertar automatico Arbol Mvias");
            System.out.println("5 Recorrido porNiveles");
            System.out.println("6 Recorrido preOrden");
            System.out.println("7 Recorrido inOrden");
            System.out.println("8 Recorrido postOrden");
    ...
    public static void menuArbolB() throws ExcepcionClaveNoexiste {
        ...
        while (!salir) {            
            ...
            System.out.println("4 Insertar automatico ArbolB ");
            System.out.println("5 Recorrido porNiveles");
            System.out.println("6 Recorrido preOrden");
            System.out.println("7 Recorrido inOrden");
            System.out.println("8 Recorrido postOrden");
