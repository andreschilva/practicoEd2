...
public class ArbolB<K extends Comparable<K>, V> extends ArbolMViasBusqueda<K, V> {
    ...
    private int fusionarseConHermanoSig(NodoMVias<K, V> nodoPadre, int posicionNodoEnProblema, 
        ...
        this.InsertarYDesplazarEnNodo(nodoEnProblema, claveDelNodoPadre, valorDelNodoPadre);
        ...
        for (int i = 0; i < nodoHermanoSig.cantidadDeClavesNoVacias(); i++) {
            ...
            this.InsertarYDesplazarEnNodo(nodoEnProblema, claveHermanoSig, valorHermanoSig);
        }
    ...
    private int fusionarseConHermanoAnt(NodoMVias<K, V> nodoPadre, int posicionNodoEnProblema, NodoMVias<K, V>nodoEnProblema , Stack<NodoMVias<K, V>> pilaDePadres, NodoMVias<K, V> nodoHermanoAnt) {
        ...
        this.InsertarYDesplazarEnNodo(nodoHermanoAnt, claveDelNodoPadre, valorDelNodoPadre);
        ...
        for (int i = 0; i < nodoEnProblema.cantidadDeClavesNoVacias(); i++) {
            ...
            this.InsertarYDesplazarEnNodo(nodoHermanoAnt, claveNodoEnProblema, valorNodoEnProblema);
        }
    ...
    private void dividir(NodoMVias<K, V> nodoActual, Stack<NodoMVias<K, V>> pilaDepadres) {
        ...
        while (nodoActual.estanClavesLlenas()) {
            ...
            if (pilaDepadres.isEmpty()) {
                ...
                this.InsertarYDesplazarEnNodo(nodoPadre,claveASubir, valorASubir);
    ...
    protected void InsertarYDesplazarEnNodo(NodoMVias<K, V> nodoActual, K claveAInsertar, V valorAInsertar) {
